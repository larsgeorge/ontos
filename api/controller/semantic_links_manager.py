...
from api.db_models.semantic_links import EntitySemanticLinkDb
from api.models.semantic_links import EntitySemanticLink, EntitySemanticLinkCreate
from api.repositories.semantic_links_repository import entity_semantic_links_repo
