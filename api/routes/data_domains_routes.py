...
from api.common.authorization import PermissionChecker # Import PermissionChecker
...
from api.models.users import UserInfo # To type hint current_user
from api.common.errors import NotFoundError, ConflictError
